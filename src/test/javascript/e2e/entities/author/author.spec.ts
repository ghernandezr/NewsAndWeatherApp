...
describe('Author e2e test', () => {
  ...
  it('should load Authors', async () => {
    ...
    expect(await authorComponentsPage.getTitle()).to.eq('cityNewsAndWeatherApp.author.home.title');
  ...
  it('should load create Author page', async () => {
    ...
    expect(await authorUpdatePage.getPageTitle()).to.eq('cityNewsAndWeatherApp.author.home.createOrEditLabel');
  ...
  it('should create and save Authors', async () => {
    ...
    await promise.all([
      ...
      authorUpdatePage.setPhoneInput('phone'),
    ]);
    ...
    expect(await authorUpdatePage.getPhoneInput()).to.eq('phone', 'Expected Phone value to be equals to phone');
  ...
  it('should delete last Author', async () => {
    ...
    expect(await authorDeleteDialog.getDialogTitle()).to.eq('cityNewsAndWeatherApp.author.delete.question');
