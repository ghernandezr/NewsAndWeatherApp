...
import com.exercise.city.config.audit.AuditEventConverter;
import com.exercise.city.domain.PersistentAuditEvent;
...
import static com.exercise.city.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
