...
/**
 * REST controller for managing {@link com.exercise.city.domain.News}.
 */
@RestController
@RequestMapping("/api")
public class NewsResource {
    ...
    public ResponseEntity<NewsDTO> updateNews(@RequestBody NewsDTO newsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, newsDTO.getId()))
            .body(result);
    }
